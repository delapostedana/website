                    ...
                    <div id="sosearchpro" class="sosearchpro-wrapper so-search ">
                        <form method="get" action="browse.php#start">
                            <div id="search0" class="search input-group form-group">
                                ...
                                <input class="autosearch-input form-control" type="text" value="" size="50" autocomplete="off" placeholder="Helical gears..." name="search" required>
                                                                    ...
                                                                    <div class="menu">
                                                                        <ul>
                                                                            <li>
                                                                                ...
                                                                                <ul>
                                                                                    <li><a href="view.php?url=elektrim-cantoni-ie1-electric-motor" >Elektrim Cantoni IE1 Motor</a></li>                                                                                    <li><a href="view.php?url=transmax-ta" >Transmax TA</a></li>                                                                                    <li><a href="view.php?url=yuema-y" >Yuema Y</a></li>                                                                                    <li><a href="view.php?url=yuema-sa" >Yuema SA</a></li>                                                                                    <li><a href="view.php?url=yuema-y3" >Yuema Y3</a></li>                                                                                    <li><a href="view.php?url=yuema-y3a" >Yuema Y3A</a></li>                                                                                    <li><a href="view.php?url=yuema-yu" >Yuema YU</a></li>                                                                                    <li><a href="view.php?url=teco-aesv1s-ie1-series" >TECO AESV1S (IE1) Series</a></li>                                                                                </ul>
                                                                            </li>
                                                                        </ul>
                                                                    </div>
                                                                </div>
                                                                    ...
                                                                    <div class="menu">
                                                                        <ul>
                                                                            <li>
                                                                                ...
                                                                                <ul>
                                                                                    <li><a href="view.php?url=quantum-vibrator-motors" >Quantum Vibrator Motors</a></li>                                                                                </ul>
                                                                            </li>
                                                                        </ul>
                                                                    </div>
                                                                </div>
                                                                    ...
                                                                    <div class="menu">
                                                                        <ul>
                                                                            <li>
                                                                                ...
                                                                                <ul>
                                                                                    <li><a href="view.php?url=transmax-mini-helical-gear-g3" >Transmax Mini Helical Gear G3</a></li>                                                                                    <li><a href="view.php?url=transmax-tr-helical-gear" >Transmax TR Helical Gear</a></li>                                                                                    <li><a href="view.php?url=transmax-helical-gear-bevel-tf" >Transmax Parallel Shaft Helical Gear TF</a></li>                                                                                    <li><a href="view.php?url=yuema-mini-helical-gear-chc" >Yuema Mini Helical Gear CHC</a></li>                                                                                    <li><a href="view.php?url=yuema-mini-helical-gear-g3" >Yuema Mini Helical Gear G3</a></li>                                                                                    <li><a href="view.php?url=yuema-helical-gear-bevel-tf" >Yuema Parallel Shaft Helical Gear TF</a></li>                                                                                    <li><a href="view.php?url=yuema-helical-bevel-gear-tk" >Yuema Helical Bevel Gear TK</a></li>                                                                                    <li><a href="view.php?url=yuema-helical-gear-bevel-tr" >Yuema Helical Gear TR</a></li>                                                                                    <li><a href="view.php?url=yuema-helical-worm-gear-ts" >Yuema Helical-Worm Gear TS</a></li>                                                                                    <li><a href="view.php?url=yuema-single-stage-helical-gear-trx" >Yuema Single Stage Helical Gear TRX</a></li>                                                                                </ul>
                                                                            </li>
                                                                        </ul>
                                                                    </div>
                                                                </div>
                                                                    ...
                                                                    <div class="menu">
                                                                        <ul>
                                                                            <li>
                                                                                ...
                                                                                <ul>
                                                                                    <li><a href="view.php?url=koshin-gl" >Koshin GL</a></li>                                                                                    <li><a href="view.php?url=koshin-pump-gb/gc" >Koshin Pump GB/GC</a></li>                                                                                    <li><a href="view.php?url=yuema-gear-pump-2cy" >Yuema Gear Pump 2CY</a></li>                                                                                    <li><a href="view.php?url=yuema-gear-pump-kcb" >Yuema Gear Pump KCB</a></li>                                                                                    <li><a href="view.php?url=yuema-gear-pump-ycb" >Yuema Gear Pump YCB</a></li>                                                                                </ul>
                                                                            </li>
                                                                        </ul>
                                                                    </div>
                                                                    <div class="menu">
                                                                        <ul>
                                                                            <li>
                                                                                ...
                                                                                <ul>
                                                                                    <li><a href="view.php?url=koshin-fill-pump-(fa,-fd,-fr)" >Koshin Fill Pump (FA, FD, FR)</a></li>                                                                                </ul>
                                                                            </li>
                                                                        </ul>
                                                                    </div>
                                                                </div>
                                                                    ...
                                                                    <div class="menu">
                                                                        <ul>
                                                                            <li>
                                                                                ...
                                                                                <ul>
                                                                                    <li><a href="view.php?url=speck-vh,-vu,-vz" >Speck VH, VU, VZ</a></li>                                                                                </ul>
                                                                            </li>
                                                                        </ul>
                                                                    </div>
                                                                </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <form method="get" action="browse.php#start">
                            ...
                            <input class="autosearch-input form-control" id="first-focus" type="text" value="" size="50" autocomplete="off" placeholder="Helical gears..." name="search" required>
                            <br>
            ...
            <div id="content" class="col-sm-12">
                ...
                <div class="about-us about-demo-2">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-5 col-md-8 center-block text-center rfq-frame">



                            <hr class="spacer s">

                            <h1 class="rri-h2 rri-black">Request For Quotation</h1>
                            ...
                            <hr class="border-red-30">
                                ...
                                <p>The easy way to send buying requests to us and get quotes quickly.</p>

                                <hr class="spacer s">



                                <form action="crud/enquiry.php?v=test" method="post">



                                    <input type="hidden" name="v" value="rfq-thank-you">



                                    <div class="form-group">

                                        <input type="text" class="form-control focus-on-load" placeholder="Your full name (required)" name="Form[name]" required>

                                    </div>

                                    <div class="form-group">

                                        <input type="text" class="form-control" placeholder="Contact number that we can connect to" name="Form[phone]">

                                    </div>

                                    <div class="form-group">

                                        <input type="email" class="form-control" placeholder="Working email (required)" name="Form[email]" required>

                                    </div>

                                    <div class="form-group text-left">

                                        <label class="">Inquiring about:</label>

                                        <select class="form-control rfq-select" name="Form[product]">

                                            <option disabled selected>Select product (optional)</option>

                                            <option disabled>------------ </option>

                                            <option value="0">No particular product</option>

                                            
                                            
                                                <option value="50">Bishamon Hand Pallet</option>

                                            
                                                <option value="51">Bishamon Mobile Table Lift BX</option>

                                            
                                                <option value="52">Bishamon Skid Lift LV</option>

                                            
                                                <option value="53">Bishamon Stacker</option>

                                            
                                                <option value="54">Bishamon Table Lift NX/X</option>

                                            
                                                <option value="57">Delta Inverter VFD B</option>

                                            
                                                <option value="58">Delta Inverter VFD C</option>

                                            
                                                <option value="59">Delta Inverter VFD E</option>

                                            
                                                <option value="60">Delta Inverter VFD EL</option>

                                            
                                                <option value="61">Delta Inverter VFD F</option>

                                            
                                                <option value="62">Delta Inverter VFD L</option>

                                            
                                                <option value="63">Delta Inverter VFD M</option>

                                            
                                                <option value="64">Delta Inverter VFD S</option>

                                            
                                                <option value="1">Elektrim Cantoni IE1 Motor</option>

                                            
                                                <option value="66">INVT Inverter GD 10</option>

                                            
                                                <option value="65">INVT Inverter GD 20</option>

                                            
                                                <option value="48">Koshin Fill Pump (FA, FD, FR)</option>

                                            
                                                <option value="47">Koshin GL</option>

                                            
                                                <option value="49">Koshin Pump GB/GC</option>

                                            
                                                <option value="56">Prestar Hand Truck</option>

                                            
                                                <option value="14">Quantum Vibrator Motors</option>

                                            
                                                <option value="67">Revco Chain Coupling</option>

                                            
                                                <option value="70">Revco FCL Coupling</option>

                                            
                                                <option value="55">Revco Hand Pallet</option>

                                            
                                                <option value="74">Revco Hand Truck</option>

                                            
                                                <option value="71">Revco Intorq DC Brake BFK457</option>

                                            
                                                <option value="69">Revco JTC Coupling</option>

                                            
                                                <option value="11">Revco Worm Gear WP</option>

                                            
                                                <option value="30">Sihi AKH/AOH</option>

                                            
                                                <option value="33">Sihi CEH</option>

                                            
                                                <option value="31">Sihi MSSA</option>

                                            
                                                <option value="32">Sihi ZLND</option>

                                            
                                                <option value="36">Southern Cross ISO Pro</option>

                                            
                                                <option value="35">Southern Cross Sovereign</option>

                                            
                                                <option value="39">Speck ASK</option>

                                            
                                                <option value="40">Speck ES</option>

                                            
                                                <option value="38">Speck SK</option>

                                            
                                                <option value="37">Speck TOE-GN</option>

                                            
                                                <option value="41">Speck VH, VU, VZ</option>

                                            
                                                <option value="76">TECO AESV1S (IE1) Series</option>

                                            
                                                <option value="10">Transmax Mini Helical Gear G3</option>

                                            
                                                <option value="77">Transmax Parallel Shaft Helical Gear TF</option>

                                            
                                                <option value="73">Transmax Speed Variator TB</option>

                                            
                                                <option value="18">Transmax TA</option>

                                            
                                                <option value="19">Transmax TAB</option>

                                            
                                                <option value="17">Transmax TAL</option>

                                            
                                                <option value="75">Transmax TR Helical Gear</option>

                                            
                                                <option value="34">Transmax XO</option>

                                            
                                                <option value="42">Yuema Gear Pump 2CY</option>

                                            
                                                <option value="43">Yuema Gear Pump KCB</option>

                                            
                                                <option value="44">Yuema Gear Pump YCB</option>

                                            
                                                <option value="28">Yuema Helical Bevel Gear TK</option>

                                            
                                                <option value="6">Yuema Helical Gear TR</option>

                                            
                                                <option value="13">Yuema Helical Hypoid Gear TKM</option>

                                            
                                                <option value="27">Yuema Helical-Worm Gear TS</option>

                                            
                                                <option value="26">Yuema Mini Helical Gear CHC</option>

                                            
                                                <option value="9">Yuema Mini Helical Gear G3</option>

                                            
                                                <option value="68">Yuema Motor Cooling Fan</option>

                                            
                                                <option value="12">Yuema Parallel Shaft Helical Gear TF</option>

                                            
                                                <option value="45">Yuema Pump Vortex</option>

                                            
                                                <option value="4">Yuema SA</option>

                                            
                                                <option value="7">Yuema Single Stage Helical Gear TRX</option>

                                            
                                                <option value="29">Yuema Speed Variator UDL</option>

                                            
                                                <option value="8">Yuema Worm Gear MRV</option>

                                            
                                                <option value="72">Yuema Worm Gear MWM</option>

                                            
                                                <option value="46">Yuema XA</option>

                                            
                                                <option value="21">Yuema Y</option>

                                            
                                                <option value="15">Yuema Y3</option>

                                            
                                                <option value="22">Yuema Y3A</option>

                                            
                                                <option value="20">Yuema YAB</option>

                                            
                                                <option value="5">Yuema YAL</option>

                                            
                                                <option value="16">Yuema YBA</option>

                                            
                                                <option value="25">Yuema YBD</option>

                                            
                                                <option value="24">Yuema YU</option>

                                            
                                                <option value="23">Yuema YWE</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="product-preview inactive">

                                            <div class="row">

                                                <div class="col-xs-4">

                                                    <a href="view.php?id=" target="_blank"><img src=""></a>

                                                </div>

                                                <div class="col-xs-8 text-left desc">

                                                    <span class="category"></span>

                                                    <br>

                                                    <a href="view.php?id=" target="_blank"></a>

                                                    <br>

                                                    <a href="view.php?id=" target="_blank" class="link">View details</a>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control rfq-msg" rows="8" placeholder="Your message..." name="Form[message]"></textarea>
    ...
    <div class="mobile-tray visible-xs " id="mm-search">
        ...
        <form method="get" action="browse.php#start">
            ...
            <div id="search0" class="search input-group form-group">
                ...
                <input class="form-control mobile-search" type="text" value="" size="50" autocomplete="off" placeholder="Helical gears..." name="search" required>
