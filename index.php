        ...
        <div class="main-container">
            ...
            <div id="content">
                ...
                <div class="container">
                    ...
                    <div class="block-services container mt-5">
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 col-margin">
                                <div class="icon-service">
                                    <div class="icon"><i class="pe-7s-like2">&nbsp;</i></div>
                                    <div class="text">
                                        <h6>Sourcing Experience<br></h6>
                                        <p class="no-margin">We have over 20 years of supplying products</p>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                <div class="icon-service">
                                    ...
                                    <div class="text">
                                        <h6>Great Support Service</h6>
                                        <p class="no-margin">Contact us to get the best help and quotes</p>
                                    </div>
                                </div>
                            </div>
                        </div>
